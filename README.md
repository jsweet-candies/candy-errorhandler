# JSweet errorhandler candy

## Description

This project is a Java bridge to the errorhandler library, so that errorhandler can be used from Java (thanks to the JSweet transpiler).
